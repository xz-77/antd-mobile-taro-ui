/*! For license information please see polyfills-dom.js.LICENSE.txt */
    ...
    234: function (t, o) {
      ...
      (function () {
          ...
          for (var s = t; s; ) {
            if (s.nodeType === Node.ELEMENT_NODE) {
              ...
              if ('link' === h && 'import' === f.getAttribute('rel')) {
                if ((s = f.import) instanceof Node && !i.has(s))
                  for (i.add(s), s = s.firstChild; s; s = s.nextSibling) p(s, o, i);
                s = n(t, f);
                continue;
              }
              if ('template' === h) {
            ...
            (p(
              ...
              function (o) {
                if ('link' === o.localName && 'import' === o.getAttribute('rel')) {
                  var i = o.import;
                  i instanceof Node && ((i.__CE_isImportDocument = !0), (i.__CE_hasRegistry = !0)),
        ...
        function y(t, o) {
          if (void 0 === o.__CE_state) {
            ...
            if ((i.defaultView || (i.__CE_isImportDocument && i.__CE_hasRegistry)) && (i = t.a.get(o.localName))) {
              ...
              if (((o.__CE_state = 1), (o.__CE_definition = i), i.attributeChangedCallback))
                for (i = i.observedAttributes, s = 0; s < i.length; s++) {
                  var f = i[s],
                    h = o.getAttribute(f);
        ...
        (u.prototype.connectedCallback = function (t) {
          ...
          (u.prototype.attributeChangedCallback = function (t, o, i, s, f) {
            ...
            h.attributeChangedCallback &&
              -1 < h.observedAttributes.indexOf(o) &&
              h.attributeChangedCallback.call(t, o, i, s, f);
          }),
          (B.prototype.f = function (t) {
            var o = this.a.readyState;
            for (('interactive' !== o && 'complete' !== o) || C(this), o = 0; o < t.length; o++)
              for (var i = t[o].addedNodes, s = 0; s < i.length; s++) A(this.c, i[s]);
          }),
          (E.prototype.l = function (t, o) {
            ...
            try {
              ...
              var f = c('connectedCallback'),
                h = c('disconnectedCallback'),
                m = c('adoptedCallback'),
                _ = c('attributeChangedCallback'),
                N = o.observedAttributes || [];
            } catch (t) {
              return;
            } finally {
              this.c = !1;
        ...
        var o = window.Document.prototype.createElement,
          ...
          s = window.Document.prototype.importNode,
          f = window.Document.prototype.prepend,
          h = window.Document.prototype.append,
          m = window.DocumentFragment.prototype.prepend,
          _ = window.DocumentFragment.prototype.append,
          ...
          I = window.Element.prototype.setAttributeNS,
          ...
          function c(o) {
            return function (i) {
              ...
              for (var h = [], m = 0; m < s.length; m++) {
                var _ = s[m];
                if ((_ instanceof Element && l(_) && h.push(_), _ instanceof DocumentFragment))
                  for (_ = _.firstChild; _; _ = _.nextSibling) f.push(_);
                else f.push(_);
              }
        ...
        var ot = window.customElements;
        if (!ot || ot.forcePolyfill || 'function' != typeof ot.define || 'function' != typeof ot.get) {
          var rt = new u();
          !(function xa() {
            var t = rt;
            window.HTMLElement = (function () {
              function b() {
                var i = this.constructor,
                  s = t.g.get(i);
                if (!s) throw Error('The custom element being constructed was not registered with `customElements`.');
                var f = s.constructionStack;
                if (0 === f.length)
                  return (
                    (f = o.call(document, s.localName)),
                    Object.setPrototypeOf(f, i.prototype),
                    (f.__CE_state = 1),
                    (f.__CE_definition = s),
                    w(t, f),
                    f
                  );
                var h = f[(s = f.length - 1)];
                if (h === nt)
                  throw Error(
                    'The HTMLElement constructor was either called reentrantly for this constructor or called multiple times.'
                  );
                return (f[s] = nt), Object.setPrototypeOf(h, i.prototype), w(t, h), h;
              }
              return (
            ...
            (function ya() {
              ...
              r(Document.prototype, 'createElement', function (i) {
                ...
                Y(t, Document.prototype, { h: f, append: h });
            })(),
            Y(rt, DocumentFragment.prototype, { h: m, append: _ }),
            (function za() {
              function a(o, i) {
                Object.defineProperty(o, 'textContent', {
                  ...
                  get: i.get,
                  set: function (o) {
                    if (this.nodeType === Node.TEXT_NODE) i.set.call(this, o);
                    else {
                      var s = void 0;
                      if (this.firstChild) {
              ...
              r(Node.prototype, 'insertBefore', function (o, i) {
                ...
                r(Node.prototype, 'cloneNode', function (o) {
                  return (o = N.call(this, !!o)), this.ownerDocument.__CE_hasRegistry ? A(t, o) : v(t, o), o;
                }),
            ...
            (function Ba() {
              ...
              function d(o, i) {
                ...
                r(o, 'insertAdjacentHTML', function (t, o) {
                  ...
                  } else if ('afterbegin' === t) (s = this.firstChild), i.call(this, t, o), e(this.firstChild, s);
                  else if ('beforeend' === t) (s = this.lastChild), i.call(this, t, o), e(s || this.firstChild, null);
                  else {
                    if ('afterend' !== t)
              ...
              L &&
                ...
                M && M.get
                  ? a(Element.prototype, M)
                  : Z && Z.get
                  ? a(HTMLElement.prototype, Z)
                  : (function da(t, o) {
                      (t.b = !0), t.f.push(o);
                    })(t, function (t) {
                      a(t, {
                        ...
                        set: function (t) {
                          var o = 'template' === this.localName,
                            s = o ? this.content : this,
                            f = i.call(document, this.namespaceURI, this.localName);
                ...
                tt
                  ? b(HTMLElement.prototype, tt)
                  : W
                  ? b(Element.prototype, W)
                  : console.warn('Custom Elements: `Element#insertAdjacentElement` was not patched.'),
                et
                  ? d(HTMLElement.prototype, et)
                  : q
                  ? d(Element.prototype, q)
                  : console.warn('Custom Elements: `Element#insertAdjacentHTML` was not patched.'),
                Y(t, Element.prototype, { h: J, append: $ }),
                (function Aa(t) {
                  function b(o) {
                    return function (i) {
                      for (var s = [], f = 0; f < arguments.length; ++f) s[f] = arguments[f];
                  ...
                  void 0 !== V && (o.before = b(V)),
                    void 0 !== V && (o.after = b(X)),
                    void 0 !== G &&
                      r(o, 'replaceWith', function (o) {
                        ...
                        for (var f = [], h = 0; h < i.length; h++) {
                          var m = i[h];
                          if ((m instanceof Element && l(m) && f.push(m), m instanceof DocumentFragment))
                            for (m = m.firstChild; m; m = m.nextSibling) s.push(m);
                          else s.push(m);
                        }
                        for (h = l(this), G.apply(this, i), i = 0; i < f.length; i++) z(t, f[i]);
          ...
          var it = new E(rt);
          Object.defineProperty(window, 'customElements', { configurable: !0, enumerable: !0, value: it });
        }
      }.call(self),
        ...
        (f = window),
        i.composedPath ||
          (i.composedPath = function () {
            if (this.path) return this.path;
            var t = this.target;
            for (this.path = []; null !== t.parentNode; ) this.path.push(t), (t = t.parentNode);
            return this.path.push(s, f), this.path;
          }),
        'function' != typeof (h = window.Element.prototype).matches &&
          (h.matches =
            h.msMatchesSelector ||
        ...
        'classList' in (m = Element.prototype) ||
          Object.defineProperty(m, 'classList', {
            get: function () {
              var t = this,
                o = (t.getAttribute('class') || '').replace(/^\s+|\s$/g, '').split(/\s+/g);
              function n() {
                o.length > 0 ? t.setAttribute('class', o.join(' ')) : t.removeAttribute('class');
              }
              return (
                '' === o[0] && o.splice(0, 1),
                (o.toggle = function (t, i) {
                  void 0 !== i
                    ? i
                      ? o.add(t)
                      : o.remove(t)
                ...
                (o.add = function () {
                  for (var t = [].slice.call(arguments), i = 0, s = t.length; i < s; i++)
                    -1 === o.indexOf(t[i]) && o.push(t[i]);
                  n();
                }),
                (o.remove = function () {
                  for (var t = [].slice.call(arguments), i = 0, s = t.length; i < s; i++)
                    -1 !== o.indexOf(t[i]) && o.splice(o.indexOf(t[i]), 1);
                  n();
                }),
                (o.item = function (t) {
                  return o[t];
