      ...
      !(function () {
            ...
            (n.prototype.THROTTLE_TIMEOUT = 100),
              ...
              (n.prototype._checkForIntersections = function () {
                ...
                this._observationTargets.forEach(function (a) {
                  var p = a.element,
                    l = c(p),
                    d = this._rootContainsTarget(p),
                    g = a.entry,
                    _ = t && d && this._computeTargetAndRootIntersection(p, r),
                    m = (a.entry = new e({
                  ...
                  g
                    ? t && d
                      ? this._hasCrossedThreshold(g, m) && this._queuedEntries.push(m)
                      : g && g.isIntersecting && this._queuedEntries.push(m)
              ...
              (n.prototype._computeTargetAndRootIntersection = function (r, a) {
                if ('none' != window.getComputedStyle(r).display) {
                  for (var p = c(r), l = f(r), d = !1; !d; ) {
                    var g = null,
                      _ = 1 == l.nodeType ? window.getComputedStyle(l) : {};
                    if ('none' == _.display) return;
                    if (
                      (l == this.root || l == t
                        ? ((d = !0), (g = a))
                        : l != t.body && l != t.documentElement && 'visible' != _.overflow && (g = c(l)),
                      g && !(p = h(g, p)))
                    )
                      break;
                    l = f(l);
              ...
              (n.prototype._getRootRect = function () {
                ...
                if (this.root) r = c(this.root);
                  ...
                  r = {
                    top: 0,
                    left: 0,
                    right: a.clientWidth || p.clientWidth,
                    width: a.clientWidth || p.clientWidth,
                    bottom: a.clientHeight || p.clientHeight,
                    height: a.clientHeight || p.clientHeight,
                  };
                }
              ...
              (n.prototype._expandRectByRootMargin = function (t) {
                var r = this._rootMarginValues.map(function (r, a) {
                    return 'px' == r.unit ? r.value : (r.value * (a % 2 ? t.width : t.height)) / 100;
                  }),
                  a = { top: t.top - r[0], right: t.right + r[1], bottom: t.bottom + r[2], left: t.left - r[3] };
              ...
              (n.prototype._hasCrossedThreshold = function (t, r) {
                var a = t && t.isIntersecting ? t.intersectionRatio || 0 : -1,
                  p = r.isIntersecting ? r.intersectionRatio || 0 : -1;
                if (a !== p)
                  for (var l = 0; l < this.thresholds.length; l++) {
                    var d = this.thresholds[l];
                    if (d == a || d == p || d < a != d < p) return !0;
                  }
              }),
        ...
        function e(t) {
          ...
          var r = this.boundingClientRect,
            ...
            l = p.width * p.height;
          this.intersectionRatio = a ? Number((l / a).toFixed(4)) : this.isIntersecting ? 1 : 0;
        }
        function n(t, r) {
          var a = r || {};
        ...
        function o(t, r, a, p) {
          'function' == typeof t.addEventListener
            ? t.addEventListener(r, a, p || !1)
            : 'function' == typeof t.attachEvent && t.attachEvent('on' + r, a);
        }
        function s(t, r, a, p) {
          'function' == typeof t.removeEventListener
            ? t.removeEventListener(r, a, p || !1)
            : 'function' == typeof t.detatchEvent && t.detatchEvent('on' + r, a);
        }
        function h(t, r) {
          var a = Math.max(t.top, r.top),
            p = Math.min(t.bottom, r.bottom),
            l = Math.max(t.left, r.left),
            d = Math.min(t.right, r.right),
            g = d - l,
            _ = p - a;
          return g >= 0 && _ >= 0 && { top: a, bottom: p, left: l, right: d, width: g, height: _ };
        }
        function c(t) {
          var r;
          try {
        ...
        function f(t) {
          var r = t.parentNode;
          return r && 11 == r.nodeType && r.host ? r.host : r && r.assignedSlot ? r.assignedSlot.parentNode : r;
        }
      })();
    },
  },
