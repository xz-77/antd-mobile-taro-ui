(window.webpackJsonp = window.webpackJsonp || []).push([
  [30],
  {
    75: function (e, n, i) {
          ...
          return (
            (t.prototype.bindevent = function () {
              ...
              this.audio.addEventListener('timeupdate', function (n) {
                e.onTimeUpdate.emit({ duration: n.srcElement.duration, currentTime: n.srcElement.duration });
              }),
                ...
                this.audio.addEventListener('error', function (n) {
                  var i;
                  e.onError.emit({ errMsg: null === (i = n.srcElement.error) || void 0 === i ? void 0 : i.code });
                });
            }),
      ...
      r.style = 'audio{max-width:100%;outline:none}';
    },
  },
]);
