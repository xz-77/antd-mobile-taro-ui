  ...
  [34],
  {
    80: function (t, n, o) {
      ...
      var i = o(29),
        r = (function () {
          function e(t) {
            var n = this;
            Object(i.g)(this, t),
              (this.onChange = Object(i.c)(this, 'checkboxchange', 7)),
              (this.value = ''),
              (this.checked = !1),
              (this.disabled = !1),
              (this.nativeProps = {}),
              ...
              return Object(i.e)(
                ...
                Object(i.e)(
                  ...
                  Object.assign(
                    {
                      ref: function (n) {
                        n && ((t.inputEl = n), t.id && n.setAttribute('id', t.id));
                      },
                      type: 'checkbox',
                      value: c,
                      name: r,
      ...
      var a = (function () {
        function e(t) {
          Object(i.g)(this, t),
            (this.onChange = Object(i.c)(this, 'change', 7)),
            (this.uniqueName = Date.now().toString(36));
        }
        return (
          (e.prototype.function = function (t) {
            if ((t.stopPropagation(), 'TARO-CHECKBOX-CORE' === t.target.tagName)) {
              var n = this.el.querySelectorAll('taro-checkbox-core');
              (this.value = this.getValues(n)), this.onChange.emit({ value: this.value });
            }
          }),
          (e.prototype.componentDidLoad = function () {
            var t = this;
            this.el.querySelectorAll('taro-checkbox-core').forEach(function (n) {
