...
import { Avatar, List, Space } from 'antd-mobile-taro-ui';
    ...
    <>
      ...
      <DemoBlock title='占位头像'>
        <Space block direction='vertical'>
          <Avatar src='' />
          <DemoDescription>如果你不传图片，或者图片加载失败，那么会显示一个默认的图像</DemoDescription>
        </Space>
      </DemoBlock>
      ...
      <DemoBlock title='配合列表使用' padding='0'>
        <List>
          <List.Item prefix={<Avatar src={demoAvatarImages[0]} />} description='Deserunt dolor ea eaque eos'>
            Novalee Spicer
          </List.Item>
        </List>
      </DemoBlock>
