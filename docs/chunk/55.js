      ...
      var o = n(29),
        r = (function () {
          function e(t) {
            var i = this;
            Object(o.g)(this, t),
              (this.onChange = Object(o.c)(this, 'radiochange', 7)),
              (this.value = ''),
              (this.checked = !1),
              (this.disabled = !1),
              (this.nativeProps = {}),
          ...
          return (
            (e.prototype.watchChecked = function (t) {
              this.isWillLoadCalled && t && this.onChange.emit({ value: this.value });
            }),
              ...
              return Object(o.e)(
                ...
                Object(o.e)(
                  ...
                  Object.assign(
                    {
                      ref: function (i) {
                        i && ((t.inputEl = i), t.id && i.setAttribute('id', t.id));
                      },
                      type: 'radio',
                      name: r,
                      value: c,
                ...
                Object(o.e)('i', { class: 'weui-icon-checked' }),
        ...
        c = (function () {
          ...
          return (
            (e.prototype.function = function (t) {
              if ((t.stopPropagation(), 'TARO-RADIO-CORE' === t.target.tagName)) {
                var i = t.target;
                if (i.checked)
                  this.el.querySelectorAll('taro-radio-core').forEach(function (t) {
                    t !== i && (t.checked = !1);
                  }),
            ...
            (e.prototype.componentDidLoad = function () {
              var t = this;
              this.el.querySelectorAll('taro-radio-core').forEach(function (i) {
            ...
            (e.prototype.getValues = function (t) {
              ...
              return (
                Array.from(t).forEach(function (t) {
                  ...
                  (null == n ? void 0 : n.checked) && (i = n.value || '');
                }),
                i
              );
            }),
            (e.prototype.render = function () {
              return Object(o.e)(o.a, { class: 'weui-cells_radiogroup' });
            }),
            Object.defineProperty(e.prototype, 'el', {
              get: function () {
                return Object(o.d)(this);
