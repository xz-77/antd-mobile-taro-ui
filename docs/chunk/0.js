  ...
  Array(124).concat([
      ...
      function updateProp(t, e, r, o, n) {
        ...
        if ('children' !== r)
          if ('classname' !== r.toLowerCase()) {
            if ('style' !== r) {
              if ((/^data-.+/.test(r) && c.setAttribute(r, a), 'taro-scroll-view-core' === e)) {
              ...
              if ('function' == typeof a && r.match(/^on[A-Z]/)) {
                ...
                return (
                  'taro-scroll-view-core' === e &&
                    'scroll' === u &&
                    (s = function fn(t) {
                      t instanceof CustomEvent && a.apply(null, Array.from(arguments));
                    }),
                  t.eventHandlers.push([u, s]),
            ...
            c.className = o
              ? (function getClassName(t, e, r) {
                  var o = Array.from(t.classList),
                    n = (e.className || e.class || '').split(' '),
                  ...
                  return (
                    ...
                    (a = [].concat(m()(a), m()(c))).join(' ')
                  );
                })(c, o, n)
              : a;
      }
      var w = function reactifyWebComponent(t) {
        var e = (function (e) {
          b()(Index, e);
          var r = _createSuper(Index);
          function Index(t) {
            var e;
            return l()(this, Index), ((e = r.call(this, t)).eventHandlers = []), (e.ref = Object(o.createRef)()), e;
          }
          return (
            y()(Index, [
              {
                  ...
                  this.clearEventHandlers(),
                    this.ref.current &&
                      (Object.keys(e || {}).forEach(function (o) {
                        'children' === o || 'key' === o || o in r.props || updateProp(r, t, o, e, r.props);
                      }),
                      Object.keys(this.props).forEach(function (o) {
                        updateProp(r, t, o, e, r.props);
                      }));
                },
              },
              {
              ...
              },
              {
                ...
                value: function componentDidMount() {
                  ...
                  'function' == typeof t
                    ? t(this.ref.current)
                    : t && 'object' === f()(t) && t.hasOwnProperty('current')
                    ? (t.current = this.ref.current)
                    : 'string' == typeof t && console.warn('内置组件不支持字符串 ref'),
                    this.update();
                },
              },
              {
              ...
              },
              {
                ...
                value: function render() {
                  var e = this.props,
                    ...
                    c = { ref: this.ref };
                  return n && (c.dangerouslySetInnerHTML = n), Object(o.createElement)(t, c, r);
                },
              },
            ]),
            Index
        ...
        return n.a.forwardRef(function (t, r) {
          return n.a.createElement(e, _objectSpread(_objectSpread({}, t), {}, { forwardRef: r }));
        });
      };
      w('taro-input-core'), n.a.createElement;
      var _ = w('taro-view-core'),
        P = (w('taro-icon-core'), w('taro-progress-core'), w('taro-rich-text-core'), w('taro-text-core')),
        S =
          (w('taro-button-core'),
          w('taro-checkbox-core'),
          w('taro-checkbox-group-core'),
          w('taro-editor-core'),
          w('taro-form-core'),
          w('taro-label-core'),
          w('taro-picker-core'),
          w('taro-picker-view-core'),
          w('taro-picker-view-column-core'),
          w('taro-radio-core'),
          w('taro-radio-group-core'),
          w('taro-slider-core'),
          w('taro-switch-core'),
          w('taro-cover-image-core'),
          w('taro-textarea-core'),
          w('taro-cover-view-core'),
          w('taro-movable-area-core'),
          w('taro-movable-view-core'),
          w('taro-scroll-view-core'),
          w('taro-swiper-core'),
          w('taro-swiper-item-core'),
          w('taro-functional-page-navigator-core'),
          w('taro-navigator-core'),
          w('taro-audio-core'),
          w('taro-camera-core'),
          w('taro-image-core'));
      w('taro-live-player-core'),
        w('taro-video-core'),
        w('taro-map-core'),
        w('taro-canvas-core'),
        w('taro-ad-core'),
        w('taro-official-account-core'),
        w('taro-open-data-core'),
        w('taro-web-view-core'),
        w('taro-navigation-bar-core'),
        o.Fragment,
        w('taro-custom-wrapper-core');
    },
    ,
    ,
    function (t, e, r) {
      ...
      !(function () {
          ...
          for (var t = [], e = 0; e < arguments.length; e++) {
            ...
            if (r) {
              ...
              if ('string' === o || 'number' === o) t.push(r);
                ...
                if (r.toString === Object.prototype.toString) for (var i in r) c.call(r, i) && r[i] && t.push(i);
        ...
        t.exports
          ? ((classNames.default = classNames), (t.exports = classNames))
          : 'object' === n(r(157)) && r(157)
          ? void 0 ===
              (o = function () {
                return classNames;
              }.apply(e, [])) || (t.exports = o)
    ...
    function (t, e, r) {
      var o = r(158),
        ...
        f = c(function (t, e) {
          if (i(e) || a(e)) n(e, u(e), t);
          else for (var r in e) s.call(e, r) && o(t, r, e[r]);
        });
      t.exports = f;
    },
    function (t, e, r) {
    ...
    function (t, e, r) {
      ...
      t.exports = function baseGetTag(t) {
        return null == t ? (void 0 === t ? '[object Undefined]' : '[object Null]') : a && a in Object(t) ? n(t) : c(t);
      };
    },
    function (t, e, r) {
      var o = r(14).default,
    ...
    function (t, e, r) {
      ...
      t.exports = function assignValue(t, e, r) {
        var a = t[e];
        (c.call(t, e) && n(a, r) && (void 0 !== r || e in t)) || o(t, e, r);
      };
    },
    function (t, e, r) {
      var o = r(160);
    ...
    function (t, e, r) {
      var o = r(158),
        n = r(159);
      t.exports = function copyObject(t, e, r, c) {
        var a = !r;
        r || (r = {});
        for (var i = -1, u = e.length; ++i < u; ) {
          var s = e[i],
            f = c ? c(r[s], t[s], s, r, t) : void 0;
          void 0 === f && (f = t[s]), a ? n(r, s, f) : o(r, s, f);
        }
        return r;
      };
    },
    function (t, e, r) {
      var o = r(189),
        n = r(196);
      t.exports = function createAssigner(t) {
        return o(function (e, r) {
          ...
          for (
            a = t.length > 3 && 'function' == typeof a ? (c--, a) : void 0,
              i && n(r[0], r[1], i) && ((a = c < 3 ? void 0 : a), (c = 1)),
              e = Object(e);
            ++o < c;
    ...
    function (t, e, r) {
      ...
      if (((e.Fragment = 60107), 'function' == typeof Symbol && Symbol.for)) {
        var c = Symbol.for;
        (n = c('react.element')), (e.Fragment = c('react.fragment'));
      }
      ...
      function q(t, e, r) {
        var o,
          ...
          s = null,
          f = null;
        for (o in (void 0 !== r && (s = '' + r),
        void 0 !== e.key && (s = '' + e.key),
        void 0 !== e.ref && (f = e.ref),
        e))
          i.call(e, o) && !u.hasOwnProperty(o) && (c[o] = e[o]);
        if (t && t.defaultProps) for (o in (e = t.defaultProps)) void 0 === c[o] && (c[o] = e[o]);
        return { $$typeof: n, type: t, key: s, ref: f, props: c, _owner: a.current };
      }
      (e.jsx = q), (e.jsxs = q);
    },
    function (t, e, r) {
    ...
    function (t, e, r) {
      ...
      t.exports = function baseIsNative(t) {
        return !(!c(t) || n(t)) && (o(t) ? l : i).test(a(t));
      };
    },
    function (t, e, r) {
      var o = r(162),
    ...
    function (t, e, r) {
      var o,
        n = r(186),
        c = (o = /[^.]+$/.exec((n && n.keys && n.keys.IE_PROTO) || '')) ? 'Symbol(src)_1.' + o : '';
    ...
    function (t, e, r) {
      var o = r(167),
        n = r(190),
        c = r(192);
      t.exports = function baseRest(t, e) {
        return c(n(t, e, o), t + '');
      };
    },
    function (t, e, r) {
      var o = r(191),
        n = Math.max;
      t.exports = function overRest(t, e, r) {
        return (
          (e = n(void 0 === e ? t.length - 1 : e, 0)),
          function () {
            for (var c = arguments, a = -1, i = n(c.length - e, 0), u = Array(i); ++a < i; ) u[a] = c[e + a];
            a = -1;
            for (var s = Array(e + 1); ++a < e; ) s[a] = c[a];
            return (s[e] = r(u)), o(t, this, s);
          }
        );
      };
    },
    ...
    function (t, e, r) {
      var o = r(194),
        ...
        a = n
          ? function (t, e) {
              return n(t, 'toString', { configurable: !0, enumerable: !1, value: o(e), writable: !0 });
            }
          : c;
      t.exports = a;
    },
    ...
    function (t, e, r) {
      ...
      t.exports = function isIterateeCall(t, e, r) {
        if (!i(r)) return !1;
        var u = o(e);
        return !!('number' == u ? c(r) && a(e, r.length) : 'string' == u && e in r) && n(r[e], t);
      };
    },
    function (t, e, r) {
      var o = r(198),
    ...
    function (t, e, r) {
      var o = r(200),
        ...
        u = o(
          ...
          ? o
          : function (t) {
              return n(t) && a.call(t, 'callee') && !i.call(t, 'callee');
            };
      t.exports = u;
    },
    function (t, e, r) {
    ...
    function (t, e, r) {
      (function (t) {
        var o = r(14).default,
          ...
          i = a && 'object' == o(t) && t && !t.nodeType && t,
          u = i && i.exports === a ? n.Buffer : void 0,
          s = (u ? u.isBuffer : void 0) || c;
        t.exports = s;
      }.call(this, r(172)(t)));
    },
    function (t, e) {
    ...
    function (t, e, r) {
      (function (t) {
        var o = r(14).default,
          ...
          a = c && 'object' == o(t) && t && !t.nodeType && t,
          i = a && a.exports === c && n.process,
          u = (function () {
            try {
    ...
    function (t, e, r) {
      var o = r(210)(Object.keys, Object);
      t.exports = o;
    },
    function (t, e) {
