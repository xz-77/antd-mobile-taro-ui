        ...
        a = (function () {
          function e(t) {
            ...
            Object(o.g)(this, t),
              ...
              (this.onChanging = Object(o.c)(this, 'changing', 7)),
              (this.min = 0),
              (this.max = 100),
              (this.step = 1),
              (this.disabled = !1),
              ...
              (this.handleTouchMove = function (t) {
                var n = i,
                  ...
                  c = n.ogX,
                  u = n.ogPercent;
                if (a && !o && t.targetTouches[0].identifier === r) {
                  t.preventDefault();
                  var d = ((t.targetTouches[0].pageX - c) / h) * 100 + u,
                    f = s + 0.01 * (d = Math.max(0, Math.min(d, 100))) * (l - s);
                  i.updateByStep(f), i.onChanging.emit({ detail: t.detail, value: i.val });
                }
              }),
              (this.handleTouchEnd = function (t) {
                ...
                n.touching &&
                  !o &&
                  (i.percent !== i.ogPercent && i.onChange.emit({ detail: t.detail, value: i.val }),
                  (i.touching = !1),
                  (i.touchId = null),
                  (i.ogX = 0),
                  (i.ogPercent = 0));
          ...
          return (
            ...
            (e.prototype.componentWillLoad = function () {
              ...
              var t = this,
                ...
                o = t.min;
              if (null !== i) {
                var a = Math.max(o, Math.min(i, n));
                this.updateByStep(a);
              }
            }),
            (e.prototype.updateByStep = function (t) {
              for (var i = this, n = i.max, o = i.min, a = i.step, r = Math.floor((n - o) / a), h = 0; h <= r; h++) {
                var l = o + a * h,
                  s = h === r ? null : o + a * (h + 1);
                if (t === l) break;
              ...
              return Object(o.e)(
                ...
                Object(o.e)(
                  ...
                  Object(o.e)(
                    ...
                    Object(o.e)('div', { style: p, class: 'weui-slider__track' }),
                    Object(o.e)('div', {
                    ...
                    Object(o.e)('input', { type: 'hidden', name: l, value: c })
                  )
                ),
                n && Object(o.e)('div', { class: 'weui-slider-box__value' }, c)
              );
            }),
